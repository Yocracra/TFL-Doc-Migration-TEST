---
title: "3D Scanner Safety Manual"
source_id: "1pRdhVBGLOfc8Oj8rDBNgAxtoPtMEVQo4vHT3IByobYA"
modified: "2026-04-09T21:29:54.280Z"
---

3D Scanner Safety Manual
...
Linked Operations Manual: [Praxis PS 3D Scanner Operations Manual](<https://www.google.com/url?q=https://docs.google.com/document/u/0/d/1esRY3jfmFp81NKIGSTxYHIxJP2jztSMbBimA8Ux1l8E/edit&sa=D&source=editors&ust=1776804253143735&usg=AOvVaw12CMyrn_WtQ7cBXOTqOWad>)

## 1\. Purpose of This Safety Manual

This document outlines the minimum safety information required to operate the Creality Raptor Pro 3D Scanner in the Fab Lab. It focuses on:
...
Be aware of the following hazards when using this machine:
  ...
  * Vision – The lasers are Class-1, but please don’t look at them.
...
Know the location and function of the following before operating the machine:
  ...
  * Emergency Stop: N/A
  * Power Disconnect: Pull the plug from the wall, and the USB from your computer.
...
Isopropanol (Scanning Spray) Safety:

  * Latex (or similar) gloves required
  * Do not inhale, drink, or touch
  * If inhaled or drank, immediately report to staff
  * If excessive scanning spray is needed, notify staff for access to better ventilation
